  ...
  "questions": [
    {
      ...
      "options": [
        {
          "label": "PostgreSQL",
          "description": "Relational, ACID compliant, complex queries"
        },
        {
          "label": "MongoDB",
          "description": "Document store, flexible schema, good for JSON"
        },
        {
          "label": "Redis",
          "description": "In-memory, extremely fast, cache or simple data"
        },
        {
          "label": "SQLite",
          "description": "Embedded, no server needed, simple projects"
        }
      ]
    }
  ]
...
**Claude**: _Uses structured questions for baseline + conversational follow-ups_
...
**Claude**: _Generates lean PRD matching complexity_
...
**Claude**: _Deep exploration across all phases_
...
**Claude**: _Generates comprehensive PRD with full detail_
