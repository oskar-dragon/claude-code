...
git clone https://github.com/oskar-dragon/claude-code.git ~/.config/opencode/superpowers
```
...
- Report issues: https://github.com/oskar-dragon/claude-code/issues
- Documentation: https://github.com/oskar-dragon/claude-code
```
