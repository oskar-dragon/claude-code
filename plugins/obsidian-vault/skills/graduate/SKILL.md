...
For each candidate:
- mcp__qmd__vector_search for the concept/idea
...
**In both cases — update source journal entries:**
5. Go back to each source journal entry and add `[[Note Title]]` as a wikilink where the concept was first mentioned
6. Use Edit for each source journal file
